            ...
            <Col lf={12}>
              <div className="table-title mt-5">
                ...
                <p className="my-3 mt-xs-5">
                  Clikkle Campaigns is a part of Clikkle Workspace
                </p>
      ...
      <section className="mt-5 mb-5">
        <Container>
          <Table responsive bordered className="text-center table">
              ...
              <tr>
                ...
                <td>
                  <div className="text-center">
                    <p className="pb-5">For Personal (no cost)</p>
                    <Button variant="outline-primary  mb-5" size="lg">
                      Go to Campaigns
                    </Button>
                  </div>
                </td>
                <td>
                  <div className="text-center">
                    <p className="pb-5">Business Standard</p>
            ...
            <tbody>
              <tr>
                <td className="col1">Drive Secure cloud storage</td>
                <td>15 GB per user</td>
                <td>2 TB per user</td>
              </tr>
              <tr>
                <td className="col1">Target audience sharing</td>
                <td>----</td>
                <td>
                  <AiOutlineCheck />
                </td>
              ...
              <tr>
                <td className="col1">Shared drives for your team</td>
                <td>----</td>
                <td>
                  <AiOutlineCheck />
                </td>
              ...
              <tr>
                <td className="col1">
                  Clikkle Docs, Sheets, Slides, Forms content creation
                </td>
                <td>
                  <AiOutlineCheck />
                </td>
              ...
              <tr>
                <td className="col1">Clikkle Cmail Secure email</td>
                <td>
                  <AiOutlineCheck />
                </td>
                <td>
              ...
              <tr>
                <td className="col1">
                  Clikkle Meet Meet Video and voice conferencing
                </td>
                <td>100 participants</td>
                <td>150 participants</td>
              </tr>
              <tr>
                <td className="col1">Meeting recordings saved to Drive</td>
                <td>----</td>
                <td>
                  <AiOutlineCheck />
                </td>
              ...
              <tr>
                <td className="col1">
                  Security administrations Admin Centralized administration
                </td>
                <td>----</td>
                <td>
                  <AiOutlineCheck />
              ...
              <tr>
                <td className="col1">Group-based security policy controls</td>
                <td>----</td>
                <td>
                  <AiOutlineCheck />
                </td>
